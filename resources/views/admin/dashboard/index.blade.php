<div class="dashboard">
  @include('admin.layouts.header')
      ...
      <div class="container-fluid py-4">
        <div class="row">
          <?php $panels = ['clients' => ['name' => 'All Clients', 'count' => rand(45, 209), 'text' => '', 'icon' => 'ni-money-coins']]; ?>
          @if(!empty($panels))
            @foreach($panels as $panel => $details)
          ...
          <div class="col-lg-7 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
              <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Payments Overview</h6>
