<form class="upload-document-form" id="upload-document-form" action="javascript:;" method="post" data-action="{{ route('admin.document.upload', ['model_id' => $model_id, 'model' => $model, 'client_id' => $client_id]) }}" enctype="multipar/form-data">
    @csrf
    <div class="row">
