...
<a href="{{route('home')}}">Home</a> > <span class="current">Category: Buildings</span>
</div>					</div>
								</div>				
		</div>
	</div>
...
<a aria-current="page" href="{{route('building')}}">Buildings</a>
</li>
...
<a href="{{route('technology')}}">Technology</a>
				...
				<input type="submit" class="search-submit" value="Search">
						...
						<a href="{{route('commercial')}}l">Commercial project With Perfection &#038; creative design</a>
...
<a aria-current="page" href="{{route('building')}}">Buildings</a><span>2</span>
</li>
	<li class="cat-item cat-item-3">
