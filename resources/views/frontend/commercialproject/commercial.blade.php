...
<a href="./../index.html">Home</a> > <span class="kyber-readcrumb"><a href="{{route('building')}}">Buildings</a></span> > <span class="current">Commercial project With Perfection & creative design</span>
</div>					</div>
								</div>				
		</div>
	</div>
