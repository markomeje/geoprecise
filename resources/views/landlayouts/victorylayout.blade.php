...
<head>
    ...
    <title>Victory Layout &#8211; GeoPrecise</title>
...
<ul class="sub-menu">
    ...
    <ul class="social-info">
                ...
                <a class="social-icon" target="_blank" href="https://www.instagram.com/geoprecise1" rel="nofollow"><i class="fab fa-instagram"></i></a>
                    ...
                    <a href="{{route('home')}}">Home</a> > <a href="{{route('layouts')}}">Layouts</a> > <span class="current">Victory Layout</span>
                    </div>                  </div>
                                                    </div>              
                            </div>
                        </div>
                    ...
                    <div class="row">
                          <div class="col-12 mt-3 mb-1">
                            <h4 class="text-uppercase">Victory Layout</h4>
                          </div>
                        </div>
                      <div class="card">
                        <div class="row ">
