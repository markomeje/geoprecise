...
<head>
    ...
    <title>Eastern Homes Estate Layout &#8211; GeoPrecise</title>
...
<ul class="sub-menu">
    ...
    <ul class="social-info">
                ...
                <a class="social-icon" target="_blank" href="https://www.instagram.com/geoprecise1" rel="nofollow"><i class="fab fa-instagram"></i></a>
                    ...
                    <a href="{{route('home')}}">Home</a> > <a href="{{route('layouts')}}">Layouts</a> > <span class="current">Eastern Homes Estate Layout</span>
                    </div>                  </div>
                                                    </div>              
                            </div>
                        </div>
                    </div>
                    <link rel="stylesheet" id="owl-carousel-css" href="././assets/layoutcards.css" type="text/css" media="all">
                     <div class="container" style="margin-top:70px; margin-bottom:60px;">
                    <div class="row">
                          <div class="col-12 mt-3 mb-1">
                            <h4 class="text-uppercase">Eastern Homes Estate Layout</h4>
                          </div>
                        </div>
                      <div class="card">
                        <div class="row ">
                            ...
                            <div id="CarouselTest" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img class="d-block" src="././images/layouts/land09.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                  <img class="d-block" src="././images/layouts/land01.jpeg" alt="">
                                </div>
                                <div class="carousel-item">
                                  <img class="d-block" src="././images/layouts/land.jpg" alt="">
                                </div>
